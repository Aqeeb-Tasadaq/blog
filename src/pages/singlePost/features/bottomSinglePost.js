...
import singlePost2 from '../../../assets/singlePost2.png'

const BottomSinglePost = () => {
  return (
    <section className="singlePost">
    <div className="singlePost_page_width">
      <img src={singlePost1} alt="pic" />
      ...
      <img src={singlePost2} alt="pic" />
      <div className="singlePost_Advertisement">
        <div className="singlePost_inner_advertisement">
          <p>Advertisement</p>
